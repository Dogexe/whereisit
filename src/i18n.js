...
export const STRINGS = {
  ...
  filterChipCategory: ["หมวดหมู่", "Category"], filterChipAmount: ["จำนวนเงิน", "Amount"],
  ...
  upcomingBillsSection: ["รายการที่ใกล้ถึงกำหนด", "Upcoming bills"], markPaidBtn: ["ทำเครื่องหมายว่าจ่ายแล้ว", "Mark paid"],
